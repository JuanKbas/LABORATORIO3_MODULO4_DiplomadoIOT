...
class Analitica():
    ...
    def agregar_maximo(self, _medida):
        if _medida > self.valor_max:
            ...
            self.escribir("Pasos", "Maximos pasos", _medida)
    ...
    def agregar_promedio(self, _medida):
        ...
        self.prom_final = (sum(self.promedio_lista))/(self.conteo_promedio)
        self.escribir("Pasos", "Promedio final", float(self.prom_final))
    ...
    def mejor_dia(self, _medida):
        if _medida > self.mejor:
            ...
            self.escribir("Pasos", "Mejor que el dia anterior", int(self.mejor_racha))
        else:
            self.cont_mejor = 0
    ...
    def agregar_minimo(self, _medida):
        if _medida < self.valor_min:
            ...
            self.escribir("Pasos", "Minimos pasos", _medida)
